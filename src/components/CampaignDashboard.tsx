...
export function CampaignDashboard({ campaigns, campaignTeams, agents, callData, date }: CampaignDashboardProps) {
  ...
  const teamPerformance = campaignTeams.map(team => {
    ...
    const teamCalls = filteredCallData.filter(call => {
      ...
      return agent?.campaign_team_id === team.id;
    });
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Campaign Team Performance</h2>
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-100">
              {sortedTeams.map((teamData) => {
                const campaign = campaigns.find(c => c.id === teamData.team.campaign_id);
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900">{campaignTeams.length}</p>
            </div>
